...
#
namespace eval ::tclapp::xilinx::devicetree::audio_spdif {
namespace import ::tclapp::xilinx::devicetree::common::\*
	proc generate {drv_handle} {
		...
		set spdif_mode [get_property CONFIG.SPDIF_Mode [hsi::get_cells -hier $drv_handle]]
		add_prop $node "xlnx,spdif-mode" $spdif_mode int $dts_file
		set cstatus_reg [get_property CONFIG.CSTATUS_REG [hsi::get_cells -hier $drv_handle]]
		add_prop $node "xlnx,chstatus-reg" $cstatus_reg int $dts_file
		set userdata_reg [get_property CONFIG.USERDATA_REG [hsi::get_cells -hier $drv_handle]]
		add_prop $node "xlnx,userdata-reg" $userdata_reg int $dts_file
		set axi_buffer_size [get_property CONFIG.AXI_BUFFER_Size [hsi::get_cells -hier $drv_handle]]
