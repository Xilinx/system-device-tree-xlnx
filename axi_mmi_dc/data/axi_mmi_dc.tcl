...
#
    ...
    proc axi_mmi_dc_generate {drv_handle} {
        ...
        if {$aud_index >= 0 && $index >= 0} {
            add_prop $node clock-names "mmi_pll ps_vid_clk stc_ref_clk pl_vid_func_clk pl_aud_clk" stringlist $dts_file
            add_prop $node clocks "<&versal2_clk MMIPLL>, <&versal2_clk DC_PIXEL>, <&versal2_clk MMI_AUX1_REF>, <&$connected_ip $index>, <&$aud_clk_connected_ip $aud_index>" noformating $dts_file
        } elseif {$aud_index >= 0 } {
            add_prop $node clock-names "mmi_pll ps_vid_clk stc_ref_clk pl_aud_clk" stringlist $dts_file
            add_prop $node clocks "<&versal2_clk MMIPLL>, <&versal2_clk DC_PIXEL>, <&versal2_clk MMI_AUX1_REF>, <&$aud_clk_connected_ip $aud_index>" noformating $dts_file
        } elseif {$index >= 0} {
            add_prop $node clock-names "mmi_pll ps_vid_clk stc_ref_clk pl_vid_func_clk" stringlist $dts_file
            add_prop $node clocks "<&versal2_clk MMIPLL>, <&versal2_clk DC_PIXEL>, <&versal2_clk MMI_AUX1_REF>, <&$connected_ip $index>" noformating $dts_file
        }
    }
