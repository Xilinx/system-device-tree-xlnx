...
namespace eval ::tclapp::xilinx::devicetree::multi_scaler {
namespace import ::tclapp::xilinx::devicetree::common::\*
	proc generate {drv_handle} {
		...
		set max_outs [get_property CONFIG.MAX_OUTS [hsi::get_cells -hier $drv_handle]]
		...
		set taps [get_property CONFIG.TAPS [hsi::get_cells -hier $drv_handle]]
		...
		set pixes_per_clock [get_property CONFIG.SAMPLES_PER_CLOCK [hsi::get_cells -hier $drv_handle]]
		...
		set has_bgra8 [get_property CONFIG.HAS_BGRA8 [hsi::get_cells -hier $drv_handle]]
		if {$has_bgra8 == 1} {
		...
		set has_rgba8 [get_property CONFIG.HAS_RGBA8 [hsi::get_cells -hier $drv_handle]]
		if {$has_rgba8 == 1} {
			append vid_formats " " "abgr8888"
		}
		set has_rgbx10 [get_property CONFIG.HAS_RGBX10 [hsi::get_cells -hier $drv_handle]]
		if {$has_rgbx10 == 1} {
			append vid_formats " " "xbgr2101010"
		}
		set has_uyuy8 [get_property CONFIG.HAS_UYVY8 [hsi::get_cells -hier $drv_handle]]
		if {$has_uyuy8 == 1} {
		...
		set has_yuva8 [get_property CONFIG.HAS_YUVA8 [hsi::get_cells -hier $drv_handle]]
		if {$has_yuva8 == 1} {
